...
// Create
// -----------------------
export const createStaffLevelController = async (
    req: Request, 
    res: Response) => {
        try {
...
// Get All
// -----------------------
export const getStaffLevelController = async (
    req: Request,
    res:Response)=>{
        try{
...
// Get By ID
// -----------------------
export const getStaffLevelByIdController = async (
    req: Request,
    res: Response) =>{
        try{
...
// Update
// -----------------------
export const updateStaffLevelController = async (
    req: Request, 
    res: Response)=>{
        try{
            const idParam = req.params.id;
...
// Delete
// -----------------------
export const deleteStaffLevelController = async (
    req: Request, 
    res: Response) =>{
        try{
